      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <td class="text-center"><img class="img-circle img-md" src="{{ asset('images/user/' . $user->image_path) }}"
                alt="{{ $user->name }}"></td>
            ...
            <td class="align-middle text-center">+62 {{ $user->phone }}<a target="_blank"
                href="https://api.whatsapp.com/send?phone=+62{{ $user->phone }}" class="ml-2 btn btn-whatsapp">Whatsapp
